...
}).call(this, x$7); /*with semicolon*/
for (var x$8 in [0, 1, 2]) (function (x) {
    arr.push(function () {
        return x;
    });
}).call(this, x$8); /*no semicolon*/
...
// Block-less For-Of
for (var x$10 of [0, 1, 2]) (function (x) {
    arr.push(function () {
        return x;
    });
}).call(this, x$10); /*with semicolon*/
for (var x$11 of [0, 1, 2]) (function (x) {
    arr.push(function () {
        return x;
    });
}).call(this, x$11); /*no semicolon*/
